...
- [gandizm/librealsense](https://github.com/gandizm/librealsense)：从官方
  `v2.51.1` 公开 fork，默认分支 `r200-rs2-port`；
- [gandizm/realsense-ros](https://github.com/gandizm/realsense-ros)：从官方
  `4.51.1` 公开 fork，默认分支 `r200-ros2`；
- [gandizm/r200-ros2](https://github.com/gandizm/r200-ros2)：demo、
  `validation/` 工具、Skill 和中文文档，固定上述
